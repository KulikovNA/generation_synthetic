...
blenderproc_retry_total_attempts = 3
blenderproc_retry_backoff_sec = 20.0
blenderproc_retry_backoff_multiplier = 2.0
...
stereo_render = dict(
    ...
    projector_color_range=[[0.985, 0.985, 0.985], [1.0, 1.0, 1.0]],
...
stereo_branch_mode = "both"  # one of: "effective", "random", "both"
