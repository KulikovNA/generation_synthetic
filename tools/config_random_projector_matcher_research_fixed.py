...
output_dir = "/home/nikita/data_generator/generation_dataset/generation_synthetic/tools/output/differBig/random_projector_matcher_research_fixed"
...
random_projector_pattern = dict(
    seed_mode="random",   # "random" or "fixed"
    seed_value=12345,
    dot_count_range=[4000, 6000],
    dot_radius_px_range=[5.0, 10.0],
    min_sep_px_range=[1.0, 10.0],
    dot_sigma_px_range=[0.1, 2.0],
